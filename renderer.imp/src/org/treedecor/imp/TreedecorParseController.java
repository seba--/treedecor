...
import treedecor.TreedecorPlugin;
 ...
 */
public class TreedecorParseController extends SimpleLPGParseController
		implements IParseController {

	public TreedecorParseController() {
		super(TreedecorPlugin.getInstance().kLanguageID);
	}
	...
	public class TreedecorLexer extends LpgLexStream implements ILexer {
		public TreedecorLexer(String filename) throws java.io.IOException {
		}
	...
	public class TreedecorParser extends PrsStream implements IParser {
		public int numTokenKinds() {
			return 0;
		}

		public TreedecorParser(LexStream lexStream) {
		}
	...
	private TreedecorParser parser;
	private TreedecorLexer lexer;
	...
	public ISourcePositionLocator getNodeLocator() {
		return new TreedecorASTNodeLocator();
	}
	...
	private void createLexerAndParser(IPath filePath) {
		try {
			lexer = new TreedecorLexer(filePath.toOSString());
			parser = new TreedecorParser(lexer.getLexStream());
		} catch (IOException e) {
			throw new Error(e);
		}
	}
