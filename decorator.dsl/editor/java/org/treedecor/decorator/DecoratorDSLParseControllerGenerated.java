...
public class DecoratorDSLParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("DecoratorDSL");
  ...
  { 
    DecoratorDSLParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = DecoratorDSLParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = DecoratorDSLParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(DecoratorDSLParseControllerGenerated.class);
    }
  ...
  { 
    return DecoratorDSLParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
