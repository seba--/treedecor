...
import org.treedecor.imp.TreedecorParseController.ASTNode;
import org.treedecor.imp.TreedecorParseController.AbstractVisitor;
 ...
 * @since May 15, 2007
 */
public class TreedecorSourcePositionLocator implements ISourcePositionLocator {
	private final Object[] fNode = new Object[1];

	private int fStartOffset;
	private int fEndOffset;

	public TreedecorSourcePositionLocator() {
	}
	...
	private final class NodeVisitor extends AbstractVisitor {
		...
		public boolean preVisit(ASTNode element) {
			...
			//System.out.println("TreedecorNodeLocator.NodeVisitor.preVisit(ASTNode):  Examining " + element.getClass().getName() +
			...
			if (nodeStartOffset <= fStartOffset && nodeEndOffset >= fEndOffset) {
				//System.out.println("TreedecorNodeLocator.NodeVisitor.preVisit(ASTNode) SELECTED for offsets [" + fStartOffset + ".." + fEndOffset + "]");
				fNode[0] = element;
